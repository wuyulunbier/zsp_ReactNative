        ...
        return (
            <TouchableOpacity key={this.props.section.toString() + this.props.row.toString()} onPress={() => { this.props.onPress(this.props.section, this.props.row) }}>
                <View style={{ height: px2dp(100), flexDirection: 'row', backgroundColor: 'white' }}>
                    ...
                    <Text numberOfLines={2} style={{ fontSize: px2dp(25), color: 'gray', alignSelf: 'center', position: 'absolute', right: 40 }}>{this.props.tips}</Text>
                    {/* <Text numberOfLines={2} style={{Left:40,width:200,fontSize: px2dp(25), color: 'gray', alignSelf: 'center', position: 'absolute', right: 40}}>{this.props.tips}</Text> */}
